...
## Files Changed
- backend/app/routers/admin.py — column fix + SQLAlchemy pool + auth (merged)
...
- CONTEXT.md — merged develop+main, removed fixed issues

## Tests
- 66 passed, 0 failed (0.53s)

## Next
1. Run `gh auth login` + `git push -u origin main staging develop`
