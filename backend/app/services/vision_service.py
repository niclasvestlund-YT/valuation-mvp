...
from backend.app.core.thresholds import (
    EXACT_MODEL_WITHOUT_TEXT_CAP,
    GENERIC_SINGLE_IMAGE_CONFIDENCE_CAP,
    MISSING_CONCRETE_EVIDENCE_CAP,
    MULTIPLE_ALTERNATIVES_CONFIDENCE_CAP,
    STRONG_IDENTIFICATION_CONFIDENCE,
)
