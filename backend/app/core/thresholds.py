...
# ─── 5. Comparable cache + ingestion ────────────────────────────────────────

COMPARABLE_MIN_PRICE_SEK = 50
COMPARABLE_MAX_PRICE_SEK = 100_000
NEW_PRICE_MIN_SEK = 100
NEW_PRICE_MAX_SEK = 200_000
COMPARABLE_OUTLIER_RATIO = 3.0
COMPARABLE_MAX_AGE_DAYS = 90
COMPARABLE_MIN_TITLE_LENGTH = 5
COMPARABLE_SOLD_WEIGHT_BOOST = 1.2
COMPARABLE_FRESHNESS_DECAY_RATE = 0.05
COMPARABLE_CACHE_MAX_AGE_HOURS = 48

# ─── 6. Agent ────────────────────────────────────────────────────────────────

AGENT_CONTEXT_MAX_COMPARABLES = 50
AGENT_DATA_MAX_AGE_DAYS = 30
AGENT_MIN_COMPARABLES_FOR_ESTIMATE = 3
